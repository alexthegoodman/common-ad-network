...
import { XIcon, Copy, CheckCircle } from "@phosphor-icons/react";
...
<div id="common-ad-cluster" data-common-ad data-site-id="${userId}" data-ads-per-cluster="3"></div>
<script src="${baseUrl}/embed.js"></script>`;
...
CommonAdNetwork.loadAd('your-cluster-container', '${userId}', {
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
                <ul className="space-y-2 text-sm text-primary-800">
                  <li>• Add the embed code to your website (single ad or cluster)</li>
                  <li>
                    • Earn karma when visitors click on ads (CTR-based rewards)
                  </li>
                  <li>
                    • Get bonus karma (50%) if you're a smaller site (&lt;1000
                    karma)
                  </li>
                  <li>
                    • Only 1 valid click per visitor per day (spam protection)
                  </li>
                  <li>
            ...
            <div className="bg-accent-50 border border-accent-200 rounded-lg p-4">
              ...
              <p className="text-sm text-accent-700 mt-2">
                This is your unique site identifier. Keep it safe and don't
                share it publicly.
              </p>
            </div>
