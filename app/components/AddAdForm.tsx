...
import { XMark, Plus, Upload } from '@phosphor-icons/react'
...
export default function AddAdForm({ isOpen, onClose, onSuccess }: AddAdFormProps) {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                maxLength={60}
              />
              <p className="text-xs text-gray-500 mt-1">{formData.headline.length}/60 characters</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Upload image (max 5MB) or paste URL • Recommended: 400x300px or 4:3 ratio
              </p>
            </div>
            ...
            {formData.imageUrl && (
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                  ...
                  />
                  <h3 className="font-semibold text-gray-900">{formData.headline || 'Your headline'}</h3>
                  <p className="text-sm text-gray-600">{formData.description || 'Your description'}</p>
                </div>
              </div>
            )}
